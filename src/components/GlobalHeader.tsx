        ...
        <div className="relative" ref={popupRef}>
          ...
          {open && (
            <div className="absolute right-0 mt-2 w-64 bg-white border border-neutral-200 rounded-xl shadow-lg z-50 p-4 flex flex-col items-center">
              <Icon icon="icon-park-outline:user" className="w-10 h-10 mb-2 text-neutral-500" />
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded bg-neutral-100 border border-neutral-600 text-neutral-700 hover:bg-neutral-200 transition-colors font-medium"
              >
                <Icon icon="icon-park-outline:logout" className="w-5 h-5" />
                <span>Logout</span>
              </button>
            </div>
          )}
